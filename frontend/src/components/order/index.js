...
import { removeOrderItem } from 'store/actions/order';
        ...
        if (this.props.restaurant === undefined || this.props.order.length <= 0) {
            return (
                <Column size={6} offset={3}>
                    ...
                    <Title size={6} subtitle className="has-text-custom-gray-darker">
                        Escolha um produto
                    </Title>
                    <br />
                </Column>
            ...
            <Fragment>
                <Column size={12}>
                    <div className="order-box">
                        <Title size={5} className="has-text-custom-green-darker">
                            Restaurante
                        </Title>
                                ...
                                <Fragment>
                                    <Column.Group multiline gapless>
                                        ...
                                        <Column size="two-fifth" className="has-text-right">
                                            <button
                                                type="button"
                                                className="dashed_box is-size-7 remove-button"
                                                onClick={() => {
                        ...
                        <Column.Group className="subtotal">
                            ...
                            <Column size="two-fifths">
                                <Title
                                    size={6}
                                    className="has-text-custom-gray-darker has-text-right"
                                >
...
const mapDispatchToProps = (dispatch) => {
    return bindActionCreators({ removeOrderItem, hideModal }, dispatch);
};
